...
module.exports = {
  ...
  make_block:function(history){
    var temp = ``;
    var block_list = '';
    for(var i = 0 ; i<history.length; i++){
      if(history[i].state === "off"){
        temp += `
                ...
                <div>
                  ...
                  <div class="donut" id="donut_${i}" data-percent="85.4"></div>
                    <script>
                      ...
                      donut_${i}.style.background = 'conic-gradient(#3F8BC9 0% ${history[i].cpu_usage}, #F2F2F2 50% ${history[i].cpu_usage})';
                    </script>
                  </div>
                <div class="card-footer d-flex align-items-center justify-content-between">
                    <a class="small text-white stretched-link" style="color:#F5EFE6; text-decoration-line: none; font-weight:bold; font-size:1.2vw" href="http://localhost:3000/server_history">Server History</a>
