                              ...
                              <div class="row justify-content-center">
                                  <div class="col-lg-7">
                                      <div class="card shadow-lg border-0 rounded-lg mt-5">
                                          ...
                                          <div class="card-body">
                                              <form method="post" action="admin_create/create_state"  >
                                                  <div class="form-floating mb-3">
                                                      <input class="form-control" id="ip_server_name" type="text" required/>
                                                      <label for="ip_server_name">Server Name</label>
                                                  </div>
                                                  <div class="form-floating mb-3">
                                                      <input class="form-control" id="ip_key" type="text" required />
