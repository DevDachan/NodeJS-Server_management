    ...
    for(var i = 0 ; i<history.length; i++){
      if(history[i].state === null){
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4" style=" height:93%;">
    ...
    <html lang="en">
        ...
        <body class="sb-nav-fixed">
            <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                <!-- Navbar Brand-->
                <a class="navbar-brand ps-3" href="http://localhost:3000/">Server Management</a>
                <!-- Sidebar Toggle-->
  ...
  HTML_register:function(random_key){
    return `<!DOCTYPE html>
      <html lang="en">
          ...
          <a class="navbar-brand ps-3" href="http://localhost:3000/" style="background:#323232; padding:15px; border:3px solid;  color:white; font-weight: bold; width:200px; margin:20px; border-radius:100px;">Server Management</a>
